...
class AnimalQuiz{
  var images = [
    "laptop", "keyboard", "mouse", "printer","monitor"
  ];


  var questions = [
    "Whats the name of this device?.",
    "A _________ is used for typing .",
    "Point and click with a _________ ",
    "Put information on  paper with ______",
    "Display information on a  ______",
  ];


  var choices = [
    ["Cat", "Ball", "Laptop", "Box"],
    ["Cat", "Car", "Slug", "Keyboard"],
    ["Mouse", "Dog", "Elephant", "Donkey"],
    ["Pen", "Printer", "Pan", "Owl"],
    ["Board", "Monitor", "Mirror", "Paper"]
  ];
